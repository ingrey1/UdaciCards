...
const Navigation = StackNavigator({
  ...
  Deck: {screen: Deck, navigationOptions: ({ navigation }) => ({
      title: 'Deck',
    })},


  Quiz: {screen: Quiz, navigationOptions: ({ navigation }) => ({
      title: 'Quiz',
    })},


  AddDeck: {screen: AddDeck, navigationOptions: ({ navigation }) => ({
      title: 'Add Deck',
    })},


  AddCard: {screen: AddCard, navigationOptions: ({ navigation }) => ({
      title: 'Add Card',
    })} 
